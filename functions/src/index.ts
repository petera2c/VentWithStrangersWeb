...
exports.cronDecreaseTrendingScore = functions.pubsub
  .schedule("0 * * * *")
  .onRun(async () =>
    decreaseTrendingScore("trending_score", (trendingScore: any) => {
...
exports.cronDecreaseTrendingScoreDay = functions.pubsub
  .schedule("0 * * * *")
  .onRun(async () =>
    decreaseTrendingScore("trending_score_day", (trendingScore: any) => {
...
exports.cronDecreaseTrendingScoreWeek = functions.pubsub
  .schedule("0 * * * *")
  .onRun(async () =>
    decreaseTrendingScore("trending_score_week", (trendingScore: any) => {
...
exports.cronDecreaseTrendingScoreMonth = functions.pubsub
  .schedule("0 8 * * *")
  .onRun(async () =>
    decreaseTrendingScore("trending_score_month", (trendingScore: any) => {
...
const injectMetaData = (req: any, res: any) => {
  ...
  fs.readFile(filePath, "utf8", (err: any, data: any) => {
    ...
    getMetaInformation(
      req.originalUrl,
      (metaObj: any, foundPage: any, vent: any) => {
