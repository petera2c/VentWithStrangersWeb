...
function SettingsPage() {
  ...
  const handleChange = async (name: any, checked: any, notify = true) => {
...
function UserDisplay({ blockedUserID, setBlockedUsers, userID }: any) {
  const isMounted = useIsMounted();
  const [userBasicInfo, setUserBasicInfo] = useState<any>({});

  useEffect(() => {
    getUserBasicInfo((userBasicInfo: any) => {
