...
import ConversationsPageMobile from "./ConversationsPageMobile";
...
function ConversationsPage() {
  ...
  const [Page, setConversations] = useState([]);
  const [groupChatEditting, setGroupChatEditting] = useState<any>();
...
if (!isMobile) temp = ConversationsPage;
else temp = ConversationsPageMobile;
