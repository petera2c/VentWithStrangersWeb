...
export const showFiles = (
  ...
  for (let index = 0; index < newFiles.length; index++) {
    ...
    if (isFileOverSize(fileToCheck)) {
      return true;
      /*alert(
        "Please contact  for technical support. We do not currently support this file format, but we may do a software update if you contact us."
      );*/
    }
  }
...
export const getFileType = file => {
  if (isImage(file)) return "image";
    ...
    return alert("Error cannot read file extension, please contact");
  }
};
